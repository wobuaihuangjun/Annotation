...
public class ClassModel {
    ...
    private String getImportString() {
        ...
        stringBuilder.append("import com.example.annotation.demo.compilerannotation.Injectable;\n");
    ...
    private String getConstructString() {
        ...
        stringBuilder.append("public ").append(classElement.getSimpleName().toString()).append("$$view_binding")
                .append("(").append(classElement.getSimpleName()).append(" targetActivity, ").append("View view) {\n");
        stringBuilder.append("this.target = targetActivity;\n");
        for (VariableElement element : variableElements) {
